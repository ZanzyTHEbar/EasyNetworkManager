...
MDNSHandler::MDNSHandler(StateManager<MDNSState_e> *stateManager, ProjectConfig *configManager,
                         const std::string &service_name, const std::string &service_text, const std::string &proto,
...
bool MDNSHandler::startMDNS() {
    ...
    MDNS.addServiceTxt(service_name.c_str(), proto.c_str(), key.c_str(),
